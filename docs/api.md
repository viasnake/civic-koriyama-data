...
| URL | 挙動 |
| --- | --- |
| `https://koriyama-open-data-hub.alflag.org/` | ドキュメントへリダイレクトします。 |
| `https://koriyama-open-data-hub.alflag.org/docs/` | このドキュメントを表示します。 |
| `https://koriyama-open-data-hub.alflag.org/api/v2` | API のサービス情報を JSON で返します。 |
